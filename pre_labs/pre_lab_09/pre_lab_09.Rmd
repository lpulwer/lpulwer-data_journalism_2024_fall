...
<https://datawrapper.dwcdn.net/a0NLx/1/>
...
md_gov_county <- md_gov_county |>
  ...
  mutate((Percent_Moore = Moore/Total_Votes * 100))
...
**It's now zoomed in on Maryland.**
...
**When I hover over the county, the county name is displayed including the percentages of votes for Wes Moore for each county.**
...
<https://datawrapper.dwcdn.net/mdSnF/1/>
