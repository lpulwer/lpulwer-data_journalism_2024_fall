...
The state with the largest percentage growth is Nevada.
...
The County with the highest median household is Howard County.
...
None of the counties see their median incomes fall. As a matter of fact, median incomes in all counties have risen.
...
Only one of the top 20 zip codes have an estimated median household income of less than \$50,000? It's 21202 with an estimated income of 47,848\$
...
We should ask where these Maryland Zipcodes are located to see maybe if we could find a correlation between median household income and location. We should also ask demographic questions such as who are these people in terms of age, race, gender etc.
