...
There are many restaurants in it that are basically the same but R sees them as different variations. (e.g. W Millar Catering)
...
Key_collision_merge compares recipient names to see how similar they are. It then tries to suggest a standardized version of one column.  
...
Some of the variation are now the same. It's a little better but it's still not perfect. 

1. W. Millar & Co. got recognized as W. MILLAR & CO.
2. Walgreens got recognized as WALGREENS.
3. Walmart got recognized as WALMART.
...
Not really. WALGREENS 10071 still gets recognized as WALGREENS 10071 and not Walgreens. There are still some variations in it.
