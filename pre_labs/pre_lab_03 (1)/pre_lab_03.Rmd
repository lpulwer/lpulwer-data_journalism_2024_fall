...
**1640 rows have a problem. So there are problems with the data in 1640 rows.**
...
**402345 mail-in ballots have no data available. This could indication that the data simply has not been recorded maybe because it didn't seem important to record that data.**
...
**It's interesting that 12 people are apparently immortal. Or there might be a typo involved.**
...
**I think high counts for statuses like "deceased" or "legacy data" should be explored further to understand the data quality.**
...
**There are 14 rows in the data set.**
...
1.  **Column names are inconsistent**
2.  **Amounts are not in numeric form**
...
**This function** **makes all variable names consistent.**
...
**The error occurs because the "amount" field is currently character type and not a numeric type.**
...
**The new data type is numeric (dbl)**
...
**There is one duplicate (two rows). The donor's name is Derrick Hamilton.**
...
**The zip codes in the "zip" column now consist of 5 instead of 9 numbers.**
...
**Only one misspelling of Conowingo remains.**
...
**There are no more misspelings of Conowingo.**
...
**There are no mispellings of Conowingo.**
