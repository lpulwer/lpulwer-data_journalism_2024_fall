...
**There are 24 rows now.** **This matches the numbers of counties in the population data.**
...
**R has recognized the common column and joined them together.**
...
**The county with the highest percentage of the 18+ Black population is Prince George's County. There are 78.29% democrats in Prince George's County.**
...
**The largest population of Asians is in Howard county. Compared to the Black population, the Asian percentage is significantly smaller at 19.37 %.**
...
**It has been changed to a character datatype.**
