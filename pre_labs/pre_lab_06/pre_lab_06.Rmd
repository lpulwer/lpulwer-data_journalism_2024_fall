...
**Those are some weird headers. I mean, those are essentially data read as headers. Yikes!**

```{r}
benzie_2024 <- read_csv("tabula-Benzie Aug 6,2024 Official Precinct Results (1).csv")
...
**The headers are not really informative (e.g. X2, X3, etc.). We also should split the party values out and add them into to a new column.**

```{r}
benzie_2024 <- read_csv("tabula-Benzie Aug 6,2024 Official Precinct Results (1).csv", col_names = FALSE)
...
**The party affiliations are still together in one row. Also, I don't think Poll Book Totals, Grand Traverse and United States Senator should be in one column.**
